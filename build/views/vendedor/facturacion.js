                                ...
                                if (Number(data.rowsAffected[0])==0){
                                    ...
                                    document.getElementById('btnFinalizarPedido').disabled = false;                                    
                                        ...
                                        .then((data)=>{
                                            ...
                                            try {
                                                funciones.verFel(data.data[0].uuid.toString())
                                                
                                            } catch (error) {
                                                funciones.AvisoError('Abra la factura desde DOCUMENTOS')
                                            }
                                        ...
                                        .catch(()=>{
                                            funciones.AvisoError('Error al certificar la factura, intentelo desde la lista');
