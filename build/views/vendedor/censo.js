                            ...
                            <div class="card shadow col-12 card-rounded p-4">
                                ...
                                <div class="row">
                                    <div class="col-6" align="right">
                                        <button id="btnFacturar" class="btn btn-bottom-l btn-secondary btn-xl btn-circle shadow" >
                                            <i class="fal fa-arrow-left"></i>
                                        </button>
                                    </div>
                                    <div class="col-6" align="right">
                                        <button id="btnGuardar" class="btn btn-bottom-r btn-info btn-xl btn-circle shadow">
...
async function addListeners(){
    ...
    document.getElementById('btnFacturar').addEventListener('click',()=>{
        document.getElementById('btnMenu2VendedorClientes').click();
    })
